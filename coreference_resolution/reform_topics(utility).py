...
def main():
    ...
    output_file_path = "/home/michalis/Desktop/CAsT/testing/train/queries/" + output_file_name + ".txt"
    reform_txt_file(file_path, output_file_path)

    file_name = "train_topics_v1.0.json"
    file_path = "/home/michalis/Desktop/CAsT/testing/train/queries/origin/" + file_name
    output_file_name = file_name + '_reformed'
    output_file_path = "/home/michalis/Desktop/CAsT/testing/train/queries/" + output_file_name + ".txt"
