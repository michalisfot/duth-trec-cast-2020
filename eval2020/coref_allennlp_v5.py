...
def main():
    with open('/home/michalis/Desktop/CAsT/2020/2020_automatic_evaluation_topics_v1.0.json') as json_file:
    ...
    output = open("/home/michalis/Desktop/CAsT/2020/allennlp_resolved_v5.txt", "w")
    output.write(out)
    output.close()
